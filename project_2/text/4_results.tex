...
Based on the initial search, using the \mia{...} optimizer seems to be a good choice for the further investigation.
Furthermore, we note that the three best ones are \mia{those in the lr batch grid search, read names from there}. 
...
\begin{figure}
    ...
    \caption{\mia{terrible fig, must fix}}    \label{fig:grid_cancer}
\end{figure}
