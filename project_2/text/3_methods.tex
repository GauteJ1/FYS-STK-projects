...
Thirdly, we studied the activation functions of the hidden layers. At the final layer we chose to always use sigmoid for the classification problem and the identity function for the regression problem. 
