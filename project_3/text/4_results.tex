...
\mia{something about the mse (compared to the analytical solution) for the two}
Comapred to the analytical solution, the output of the neural network model has a MSE of \mia{??} while the finite difference method yields a MSE of \mia{??}. 
