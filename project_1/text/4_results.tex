...
\mia{we can consider adding ridge versus lasso versus ols for franke with no resampling here in order to follow the assignment + choose the best model for franke function}
