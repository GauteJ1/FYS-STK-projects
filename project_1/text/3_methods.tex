...
Secondly, we implement our methods on real terrain data \cite{mortengithub}. The data is taken from an area around Stavanger, Norway. We use 100 data points along each axis (i.e. $100^2$). The data is plotted in Fig. \ref{data:terrain}.
