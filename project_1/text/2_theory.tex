...
The estimated error (Eq. \ref{cv_error}) will be closer to the true generalization error measure. This is a consequence of the error being averaged over many different models, and thereby to a higher degree taking into account randomness associated with data-selection. \mia{cite} 
...
These methods also help to reduce overfitting. \mia{cite (Morten)} In a sense one is normally penalizing "too good of a fit", meaning it's harder for models too get to specialized to specifics in the training data.
